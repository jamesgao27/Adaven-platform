...
const TERMS_URL = 'https://portalflow.app/terms';
const PRIVACY_URL = 'https://portalflow.app/privacy';
        ...
        <View style={styles.card}>
              ...
              Before starting this engagement, please review and confirm the following terms.
                ...
                <View style={styles.section}>
                  ...
                  <Text style={styles.sectionText}>
                    By consenting, you agree to start a client-owned tax-filing project in Portalflow. This project is
                ...
                <View style={styles.section}>
                  ...
                  <Text style={styles.sectionText}>
                    Portalflow acts only as a transmission and collaboration platform. All required client document
                    checklists and tax-material requests are defined by the firm, not by Portalflow. Your uploaded or
                    linked tax documents are visible only to the firm you authorize. Portalflow and any third party have
                ...
                <View style={styles.checkboxSection}>
                  <CheckboxRow
                    ...
                    label="I agree to start this engagement project and collaborate with my authorized firm in Portalflow."
                  />
                  <CheckboxRow
                  ...
                  <CheckboxRow
                    ...
                    label="I understand that Portalflow is only a transmission platform, that document requirements are provided by the firm, and that only my authorized firm can view my tax materials."
                  />
                </View>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              ...
              <Text style={styles.link} onPress={() => openUrl(TERMS_URL)}>Portalflow Terms</Text>
              {' '}and{' '}
