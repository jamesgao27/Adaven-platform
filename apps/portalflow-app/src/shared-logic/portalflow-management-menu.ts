...
/** Portalflow product rows on Management. Kernel Members / Space roles come from platform-ui. */
export function getPortalflowManagementMenuItems(kind?: SpaceKind): ManagementMenuItem[] {
  if (kind === 'provider') {
