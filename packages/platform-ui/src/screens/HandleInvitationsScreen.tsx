...
import { getCurrentUser, getCurrentSpace, setCurrentSpace, getUserSpaces, isAuthenticated } from '@adaven/platform-core';
import { initializeAuthCache } from '@adaven/platform-core';
import { getPendingInvitationsForUser, acceptInvitation, declineInvitation } from '@adaven/platform-core';
...
export default function HandleInvitationsScreen() {
  ...
  const continueAfterInvitations = async () => {
    try {
      ...
      if (spaces.length > 1) {
        // Auto-select latest space and go home
